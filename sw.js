// sw.js — Service Worker for USCD DAV Class VIII SBS
const CACHE = 'davviii-v1';  // bump this on every new deployment
const SHELL = ['./'];
...
self.addEventListener('push', e => {
  const d = e.data ? e.data.json() : { title: 'DAV Class VIII', body: 'New update!' };
  e.waitUntil(
    self.registration.showNotification(d.title || 'DAV Class VIII', {
      body: d.body || '',
